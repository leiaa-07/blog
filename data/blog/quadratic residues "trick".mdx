...
- $p \equiv 1 \pmod{4}$ if $p > 2$ and $p \mid x^2+1$ i.e. -1 is a QR (aka fermat's christmas theorem)
- $p \equiv \pm 1 \pmod{8}$ if $p > 2$ and $p \mid x^2 - 2$ i.e. 2 is a QR
- $p \equiv 1 \pmod{4}$ if $p > 2$, $p \nmid k$ and $p \mid x^2+k^2$ i.e. -1 is a QR
