...
<img src="/static/images/blogs/stereogram-1.jpg" alt="example of stereogram"/>
...
<img src="/static/images/blogs/stereogram-3.jpg" alt="RDS"/>
...
<img src="/static/images/blogs/stereogram-5.jpg" alt="RDS eye diagram"/>
...
<img src="/static/images/blogs/stereogram-6.jpg" alt="RDS shift pixels"/>

OKAY SO THENNNNN, when u try to view it again, the 2 imgs will fuse right, and the pixels which are the same will just "overlap" kinda, but for the pixels that were shifted, ur left eye and right eye are gonna perceive slightly shifted imgs SO THENN when the img fuses, ur depth perception will basically kick in and it'll show up as 3d AAAA ITS SO COOL AND I HOPE THAT EXPLANATION MADE SENSE HAHAHAJDJFSSHHF
...
<img src="/static/images/blogs/stereogram-4.jpg" alt="word stereogram"/>
...
<hyvor-talk-comments website-id="11281" page-id="https://leia-mayssa.vercel.app//blog/stereograms%20are%20WOW"></hyvor-talk-comments>
