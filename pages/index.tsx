...
function Comments() {
  ...
  return (
    <div>
      <h1 className="border-b border-gray-200 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:border-gray-700 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-5xl md:leading-14 mb-4">
        comments lol
      </h1>
